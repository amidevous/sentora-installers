...
wget "https://github.com/sentora/sentora-core/raw/1.0.4/modules/sub_domains/code/webservice.ext.php" -O /etc/sentora/panel/modules/sub_domains/code/webservice.ext.php
wget "https://github.com/sentora/sentora-core/raw/1.0.4/modules/sub_domains/hooks/OnAfterDeleteClient.hook.php" -O /etc/sentora/panel/modules/sub_domains/hooks/OnAfterDeleteClient.hook.php
